...
public:
  ...
  virtual bool handleEventWithText(const char * text, bool indentation = false, bool forceCursorRightOfText = false, bool replaceLastCaracterWith = false) { return false; }
protected:
