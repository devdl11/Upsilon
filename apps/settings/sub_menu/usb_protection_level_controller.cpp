...
namespace Settings
{
    ...
    void UsbProtectionLevelController::willDisplayCellForIndex(HighlightCell *celll, int index)
    {
        ...
        MessageTableCellWithBuffer *messageComp = (MessageTableCellWithBuffer *)celll;
