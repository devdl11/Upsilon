...
constexpr SettingsMessageTree s_usbLevelSelector[4] = {SettingsMessageTree(I18n::Message::USBDefaultLevel), SettingsMessageTree(I18n::Message::USBLowLevel), SettingsMessageTree(I18n::Message::USBParanoidLevel), SettingsMessageTree(I18n::Message::USBMegaParanoidLevel)};
