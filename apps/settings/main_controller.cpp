...
constexpr SettingsMessageTree s_usbSteps[3] = {SettingsMessageTree(I18n::Message::UsbExplaination1),SettingsMessageTree(I18n::Message::UsbExplaination2),SettingsMessageTree(I18n::Message::UsbExplaination3)};
